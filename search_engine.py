...
class SearchEngineGUI:
    ...
    def perform_search(self):
        ...
        if query and query != self.placeholder:
            ...
            # Example results with clickable links
            example_results = [
            ...
            for result in example_results:
                ...
                self.results_area.insert(tk.END, "   Example description of this search result...\n\n")
            
            # Make results area read-only again
            self.results_area.config(state='disabled')
            
            self.status_var.set(f"Found {len(example_results)} results")
